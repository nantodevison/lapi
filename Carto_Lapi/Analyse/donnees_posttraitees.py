...
liste_trajet_rocade=pd.read_json(r'E:\Boulot\lapi\liste_trajet_rocade.json', orient='index')
param_cluster=pd.read_json(r'E:\Boulot\lapi\param_cluster.json', orient='index')
#fichier des plaques, en df
plaques_europ=pd.read_csv(r'E:\Boulot\lapi\plaques_europ.txt', sep=" ", header=None, names=['pays','re_plaque'])
